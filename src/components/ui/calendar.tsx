    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 rounded-lg border-border/60 text-muted-foreground hover:text-foreground hover:bg-accent hover:border-border transition-colors opacity-80 hover:opacity-100"
        ),
        ...
        day_selected:
          "bg-violet-500 text-white hover:bg-violet-500 hover:text-white focus:bg-violet-500 focus:text-white shadow-sm shadow-violet-500/30",
        ...
        day_range_middle:
          "aria-selected:bg-violet-500/15 aria-selected:text-violet-600 dark:aria-selected:text-violet-200 aria-selected:rounded-none aria-selected:shadow-none",
