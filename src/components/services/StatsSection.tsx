          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            return <motion.div key={index} initial={{
              ...
              delay: index * 0.1
                  ...
                  {Icon && <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[hsl(268,60%,50%)/20] to-[hsl(280,50%,45%)/20] flex items-center justify-center mx-auto mb-3">
                  ...
                  {stat.description && <div className="text-white/40 text-xs">
                      {stat.description}
                    </div>}
                </motion.div>;
          })}
