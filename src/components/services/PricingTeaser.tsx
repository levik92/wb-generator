...
export const PricingTeaser = () => {
  ...
  return (
    <section ref={ref} className="py-16 sm:py-24 relative overflow-hidden">
      {/* Background glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] bg-[hsl(268,83%,70%)]/8 rounded-full blur-[120px]" />
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        >
          <div className="flex items-center justify-center gap-2 mb-6">
            <Zap className="w-8 h-8 text-[hsl(268,83%,55%)]" />
            <span className="text-4xl sm:text-5xl font-bold text-gray-900">от 990₽</span>
          </div>
          <p className="text-gray-500 mb-8">за пакет токенов</p>
