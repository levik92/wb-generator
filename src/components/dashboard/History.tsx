                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3 lg:gap-4 min-w-0">
                  ...
                  <div className="flex items-start gap-4 flex-1 min-w-0">
                    {generation.generation_type === 'video' ? <div 
                        className="w-12 h-16 sm:w-14 sm:h-[4.667rem] rounded-xl flex-shrink-0 overflow-hidden border-2 border-border/50 group-hover:border-primary/30 transition-colors cursor-pointer relative group/preview"
                        onClick={() => {
                      ...
                      </div> : <div className="w-12 h-16 sm:w-14 sm:h-[4.667rem] rounded-xl flex items-center justify-center bg-primary/10 flex-shrink-0">
