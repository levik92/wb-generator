                    ...
                    {generation.generation_type === 'video' ? <div 
                      ...
                      >
                        {generation.output_data?.source_image ? (
                          <ProgressiveImage src={generation.output_data.source_image} alt="Превью" previewWidth={160} previewQuality={75} className="w-full h-full object-contain" />
                        ) : (
                      ...
                      >
                        <ProgressiveImage src={generation.output_data.images[0].image_url} alt="Превью" previewWidth={160} previewQuality={75} className="w-full h-full object-contain" onError={e => {
