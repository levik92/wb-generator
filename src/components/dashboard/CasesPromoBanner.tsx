...
export const CasesPromoBanner = ({ userId, onNavigateToBalance }: CasesPromoBannerProps) => {
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 pr-8">
            ...
            <div className="flex-1 min-w-0">
              <h3 className="text-lg sm:text-xl font-bold text-white mb-1">
                Посмотрите, какие карточки создают в сервисе
              </h3>
              <p className="text-sm text-white/80 line-clamp-2">
                Узнайте, как другие селлеры оформляют товары и увеличивают продажи с помощью наших генераций
              </p>
            </div>
