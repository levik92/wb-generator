  ...
  const plans = [
    {
      ...
      features: [
        "50 токенов (9,98₽ за токен)",
        "8 комплектов карточек товаров",
        "50 описаний товаров",
        "Поддержка в чате"
      ],
      popular: false,
    },
    {
      ...
      features: [
        "200 токенов (7,50₽ за токен)",
        "33 комплекта карточек товаров",
        "200 описаний товаров",
        "Приоритетная поддержка",
        "Скидка на дополнительные токены"
      ],
      popular: true,
    },
    {
      ...
      features: [
        "1000 токенов (5,99₽ за токен)",
        "166 комплектов карточек товаров",
