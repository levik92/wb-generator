...
export const GenerateCards = ({
  ...
  return <div className="space-y-4 sm:space-y-6 max-w-full overflow-hidden px-2 sm:px-0">
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
              ...
              <div className="flex items-center gap-2 p-2 rounded-lg bg-background/60 border border-primary/10">
                ...
                <div className="min-w-0">
                  <p className="text-xs font-medium">Бесплатные 15 токенов</p>
      ...
      {/* Generated Images */}
      {generatedImages.length > 0 && <Card className="bg-muted/30">
          <CardHeader>
          ...
          <CardContent className="px-2 sm:px-4 lg:px-6">
            ...
            <div className="mt-4 pt-4 text-xs text-muted-foreground border-t flex items-center justify-center gap-2">
              ...
              <span className="text-center">токена<span className="font-bold">{priceLoading ? '...' : photoRegenerationPrice} {photoRegenerationPrice === 1 ? 'токен' : 'токенов'}</span>. Редактирование: <span className="font-bold">{priceLoading ? '...' : photoEditPrice} {photoEditPrice === 1 ? 'токен' : 'токенов'}</span>.</span>
            </div>
          </CardContent>
        </Card>}
