      ...
      {generatedImages.length > 0 && <Card className="border-border/60 bg-card rounded-2xl animate-scale-in">
          <CardHeader>
            <div className="flex flex-col space-y-3 sm:flex-row sm:space-y-0 sm:items-center justify-between gap-4">
              ...
              <Button onClick={downloadAll} variant="ghost" className="shrink-0 w-full sm:w-auto rounded-lg h-9 px-3 text-sm font-medium text-muted-foreground hover:text-violet-700 dark:hover:text-violet-300 hover:bg-violet-500/10 transition-colors" size="sm" disabled={downloadingAll}>
                {downloadingAll ? <>
