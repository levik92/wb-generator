      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="relative">
            {/* Connection line */}
            <div className="absolute left-8 sm:left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-gray-200 via-[hsl(268,83%,60%)]/20 to-gray-200 hidden sm:block" />
            ...
            <div className="space-y-8 sm:space-y-0">
              {steps.map((step, index) => (
                ...
                >
                  ...
                  {/* Center dot (desktop) */}
                  <div className="hidden sm:block absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-4 h-4 rounded-full bg-[hsl(268,83%,55%)] shadow-lg shadow-purple-400/30 z-10" />
