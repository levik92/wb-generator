...
const faqItems = [
  {
    ...
    answer:
      "Токены — это внутренняя валюта сервиса. 1 токен = примерно 12₽. Для генерации одной карточки нужно около 5 токенов (примерно 60₽). При регистрации вы получаете 20 бесплатных токенов для тестирования.",
  },
  {
  ...
  {
    question: "Для каких товаров подходит сервис?",
    answer:
      "WBGen работает с любыми товарами для Wildberries: одежда, электроника, косметика, товары для дома, спортивные товары, детские товары и многое другое. ИИ адаптирует стиль под категорию.",
  },
  {
