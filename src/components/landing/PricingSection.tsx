...
// Static pricing plans - no database dependency
const PRICING_PLANS = [
  {
    id: "starter",
    name: "Стартовый",
                ...
                <div className="relative p-6 sm:p-8">
                  ...
                  <div className="space-y-2 mb-6 pb-6 border-b border-white/10">
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="text-white font-medium">{plan.pricePerPhoto}₽</span>
                    </div>
                    <div className="flex items-center justify-between text-sm">
                      <span className="text-white/50">1 описание</span>
                      <span className="text-white font-medium">{plan.pricePerDesc}₽</span>
                    </div>
                  </div>
                  ...
                  <ul className="space-y-3 mb-8">
                    <li className="flex items-start gap-3">
                      ...
                      <span className="text-sm text-white/70">
                        ~{plan.photoCount} карточек с инфографикой
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-5 h-5 rounded-full bg-emerald-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <span className="text-sm text-white/70">{plan.support}</span>
                    </li>
                    {plan.isPremium && (
                      <>
                        <li className="flex items-start gap-3">
                          ...
                          <span className="text-sm text-white/70">API доступ</span>
                        </li>
                        <li className="flex items-start gap-3">
                          <div className="w-5 h-5 rounded-full bg-[hsl(268,83%,58%)]/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                            <Check className="w-3 h-3 text-[hsl(268,83%,58%)]" />
                          </div>
                          <span className="text-sm text-white/70">Пакетная обработка</span>
                        </li>
                      </>
                    )}
                  </ul>
