        ...
        <ResponsiveDialogHeader>
          ...
          <ResponsiveDialogDescription className="text-center pt-2">
            {isBlocked
              ...
              : isCancelled
                ? "Окно оплаты было закрыто. Попробуйте ещё раз или выберите другой способ оплаты. Если не получится — напишите в поддержку, мы поможем."
                : "Платёж не прошёл. Попробуйте другую карту или другой способ оплаты. Если снова не получится — напишите в поддержку, мы разберёмся."}
          </ResponsiveDialogDescription>
        </ResponsiveDialogHeader>
