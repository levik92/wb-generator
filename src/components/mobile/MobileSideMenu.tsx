...
import { 
  Zap, Image, FileText, History, CreditCard, Users, 
  Settings, Tags, Newspaper, GraduationCap, Video, 
                    ...
                    return (
                      <div key={item.id} className="relative">
                        ...
                        >
                          ...
                          {item.badge && (
                            <Badge className={`ml-auto text-[10px] px-1.5 py-0.5 ${item.badgeColor || 'bg-muted text-muted-foreground'}`}>
                              {item.badge}
                            </Badge>
                          )}
                        </button>
