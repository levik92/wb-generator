...
import { Zap, Image, FileText, History, CreditCard, Gift, Settings, Tags, Newspaper, GraduationCap, Video, Moon, Sun, X, ChevronRight, HeartHandshake, Headphones } from "lucide-react";
