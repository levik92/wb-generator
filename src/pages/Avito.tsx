              ...
              {cases.map((c, i) => (
                ...
                >
                  <div
                    ...
                    style={{ background: `linear-gradient(135deg, ${AVITO}55, transparent 60%, ${AVITO_LIGHT}33)` }}
                  />
                  <div className="relative glass-card rounded-2xl border border-white/10 group-hover:border-white/20 transition-colors overflow-hidden flex flex-col h-full">
                    ...
                    <div className="p-5 flex flex-col gap-3 flex-1">
                      ...
                      <CaseStudyDialog caseId={c.id}>
                        <button
                          className="w-full text-center text-xs font-medium flex items-center justify-center gap-1.5 py-2.5 rounded-lg transition-all border mt-1 hover:gap-2"
                          style={{
                            background: `${AVITO}14`,
