          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-end">
            ...
            delay: 0.3
              ...
              <div className="relative">
                ...
                <img alt="Партнёр WBGen" className="relative z-10 max-h-[500px] w-auto object-contain object-bottom" src="/lovable-uploads/53b870f5-cf6f-4afd-87ab-73e7ef5620b6.png" />
              </div>
            </motion.div>
          </div>
        </div>
