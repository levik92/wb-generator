...
const features = [
  { icon: Percent, title: "15% комиссии", description: "С каждой покупки приглашённых пользователей", color: "from-emerald-500 to-green-600" },
  { icon: Wallet, title: "Вывод от 1000₽", description: "На карту любого банка РФ", color: "from-blue-500 to-cyan-600" },
...
const faqItems = [
  ...
  { question: "Какой процент комиссии?", answer: "Вы получаете 15% от каждой покупки токенов пользователями, которых пригласили по вашей ссылке." },
  { question: "Как вывести заработок?", answer: "В личном кабинете партнёра нажмите «Вывести средства», укажите реквизиты карты. Минимальная сумма вывода — 1000₽." },
  ...
  return (
    <ServicePageLayout>
      ...
      <ServiceHero
        ...
        subtitle="WBGen"
        description="Приглашайте пользователей и получайте 15% с каждой их покупки. Пожизненная комиссия, прозрачная статистика, быстрый вывод."
        breadcrumbs={[{ label: "Партнёрам" }]}
        badge="Зарабатывайте с WBGen"
        stats={[
          { value: "15%", label: "комиссия" },
          { value: "1000₽", label: "мин. вывод" },
