          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-end">
            ...
            delay: 0.3
              ...
              <div className="relative">
                ...
                <img alt="Партнёр WBGen" className="relative z-10 max-h-[500px] w-auto object-contain object-bottom" src="/lovable-uploads/b3b247fa-9a85-407c-ad7b-a7f17851db72.png" />
              </div>
            </motion.div>
          </div>
        </div>
