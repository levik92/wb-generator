...
const faqItems = [{
  ...
  answer: "Токены можно получить несколькими способами: при регистрации вы получаете 10 бесплатных токенов, можете пополнить баланс в разделе 'Баланс', пригласить друзей по реферальной программе или использовать промокоды."
}, {
