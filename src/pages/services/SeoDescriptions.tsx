...
const faqItems = [
  ...
  },
  {
    ...
    answer: "Генерация одного SEO-описания тратит меньше токенов, чем создание визуальной карточки. При регистрации вы получаете бесплатные токены для тестирования. Точную стоимость смотрите на странице тарифов.",
  },
  {
  ...
  return (
    <ServicePageLayout>
      ...
      <ServiceHero
        ...
        description="Генерируйте продающие описания по формуле AIDA за 30 секунд. ИИ анализирует топовых конкурентов, подбирает ключевые слова и создаёт текст, который увеличивает конверсию на 35%."
        ...
        ctaText="Создать описание бесплатно"
