  ...
  return (
    <ServicePageLayout>
      <Helmet>
        ...
        <meta
          name="description"
          content="Генерация дизайна карточек для Wildberries, Ozon и Яндекс Маркет с помощью нейросети. Профессиональная инфографика, 10+ стилей, готовые PNG за 3 минуты. От 59₽ за карточку."
        />
