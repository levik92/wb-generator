...
import { ArrowLeft, Loader2, Eye, EyeOff, Mail, Lock, User, Sparkles } from "lucide-react";
          ...
          <div className="glass-card rounded-3xl p-6 sm:p-8 border border-white/10 hover:border-white/30 transition-colors">
            ...
            <div className="text-center mb-8">
              <Link to="/" className="inline-flex items-center gap-2 mb-4">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[hsl(268,83%,58%)] to-[hsl(280,83%,58%)] flex items-center justify-center">
                  <Sparkles className="w-5 h-5 text-white" />
                </div>
                <span className="text-xl font-bold text-white">WBGen</span>
              </Link>
