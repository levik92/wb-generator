          ...
          <CardContent className="space-y-6 text-sm sm:text-base">
            <div>
              ...
              <p className="mb-4 text-muted-foreground leading-relaxed">
                1.1. Настоящая Политика конфиденциальности персональных данных (далее — «Политика») действует в отношении всей информации, которую сервис WB Генератор (wbgen.ru), принадлежащий ООО «АЛЬТАИР», может получить о Пользователе во время использования сайта и сервисов.
              </p>
              <p className="mb-4 text-muted-foreground leading-relaxed">
