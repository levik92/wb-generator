        ...
        <Card className="rounded-2xl border-border">
          ...
          <CardContent className="space-y-6 text-sm sm:text-base">
            ...
            <div>
              ...
              <p className="mt-3 text-muted-foreground">
                5.2. Приём платежей осуществляется ИП Кот Александр Сергеевич (ИНН 502007134804) в качестве платёжного агента. Ему передаются только данные, необходимые для проведения платежа.
              </p>
            </div>
