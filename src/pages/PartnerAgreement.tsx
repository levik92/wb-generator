          ...
          <Card className="rounded-2xl border-border">
            ...
            <CardContent className="space-y-4 text-sm sm:text-base">
              <p className="text-muted-foreground leading-relaxed">
                1.1. Настоящий текст является официальным предложением (публичной офертой) Общества с ограниченной ответственностью «АЛЬТАИР» при использовании онлайн-сервиса WBGen, доступного в сети Интернет по адресу: https://wbgen.ru (далее — «Организатор»).
              </p>
              <p className="text-muted-foreground leading-relaxed">
