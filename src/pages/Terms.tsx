          ...
          <CardContent className="space-y-6 text-sm sm:text-base">
            <div>
              ...
              <p className="mb-4 text-muted-foreground leading-relaxed">
                1.1. Настоящий Договор-оферта (далее — «Договор») является официальным предложением Общества с ограниченной ответственностью «АЛЬТАИР» (далее — «Исполнитель») на оказание услуг по генерации карточек товаров, SEO-описаний и иных сервисов для маркетплейсов.
              </p>
              <p className="mb-4 text-muted-foreground leading-relaxed">
            ...
            <div>
              ...
              <p className="mb-3 text-muted-foreground">4.1. Доступ к услугам предоставляется на основе пакетов токенов. Действующие тарифы:</p>
              <ul className="list-disc list-inside space-y-1 ml-4 text-muted-foreground">
                <li>«Пробный» — 490 ₽, 35 токенов</li>
                <li>«Стартовый» — 990 ₽, 80 токенов</li>
                <li>«Базовый» — 2 990 ₽, 250 токенов</li>
                <li>«Профессиональный» — 9 990 ₽, 850 токенов</li>
                <li>«Бизнес» — 26 990 ₽, 2 500 токенов</li>
                <li>«Корпоративный» — 49 990 ₽, 5 000 токенов</li>
              </ul>
              <p className="mt-3 text-muted-foreground">
                4.2. Стоимость операций в токенах:
              </p>
              <ul className="list-disc list-inside space-y-1 ml-4 text-muted-foreground">
                <li>Генерация изображения: 5 токенов</li>
                <li>Редактирование карточки: 2 токена</li>
                <li>Перегенерация изображения: 1 токен</li>
                <li>SEO-описание: 1 токен</li>
              </ul>
              <p className="mt-3 text-muted-foreground">
                4.3. Исполнитель вправе изменять стоимость тарифов и операций. Актуальные цены отображаются на сайте.
              </p>
              <p className="mt-3 text-muted-foreground">
                4.4. Приём платежей от Заказчиков по поручению Исполнителя могут осуществлять привлечённые платёжные агенты, действующие на основании соответствующих агентских договоров. Перечень платёжных агентов и их реквизиты указаны в разделе «Реквизиты Исполнителя и платёжных агентов» настоящего Договора. Платёжный агент действует от своего имени, но за счёт и в интересах Исполнителя; обязательства Заказчика по оплате считаются исполненными с момента поступления денежных средств платёжному агенту.
              </p>
              <p className="mt-3 text-muted-foreground">
                4.5. Для Заказчиков, оплачивающих услуги в иностранной валюте либо с территории Республики Беларусь и иных государств, приём платежей может осуществляться платёжным агентом — Индивидуальным предпринимателем Левицким Владиславом Сергеевичем (Республика Беларусь, УНП 192485539), действующим на основании агентского договора с Исполнителем. Реквизиты указанного платёжного агента приведены в разделе реквизитов настоящего Договора.
              </p>
            </div>
            ...
            <div className="p-4 rounded-xl bg-secondary/50">
              <p className="font-medium mb-3 text-sm">Реквизиты Исполнителя и платёжных агентов:</p>
              <p className="text-xs font-semibold mb-2">Исполнитель:</p>
              <ul className="list-none space-y-1 text-xs text-muted-foreground mb-4">
              ...
              <p className="text-xs font-semibold mb-2">Платёжный агент (Республика Беларусь):</p>
              <ul className="list-none space-y-1 text-xs text-muted-foreground">
                <li><strong>Наименование:</strong> Индивидуальный предприниматель Левицкий Владислав Сергеевич</li>
                <li><strong>УНП:</strong> 192485539</li>
                <li><strong>Банк:</strong> ЗАО «БСБ Банк»</li>
                <li><strong>БИК банка:</strong> UNBSBY2X</li>
                <li><strong>IBAN:</strong> BY88UNBS30131128430030001933</li>
              </ul>
            </div>
          </CardContent>
        </Card>
