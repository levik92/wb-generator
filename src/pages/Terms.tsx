        ...
        <Card className="rounded-2xl border-border">
          ...
          <CardContent className="space-y-6 text-sm sm:text-base">
            <div>
              ...
              <p className="mb-4 text-muted-foreground leading-relaxed">
                1.3. Приём платежей осуществляется агентом — ИП Кот Александр Сергеевич (ИНН 502007134804, ОГРН 319500700012749) от имени и в интересах Исполнителя.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mb-3 text-muted-foreground">4.1. Стоимость услуг определяется в токенах согласно действующим тарифам:</p>
              <ul className="list-disc list-inside space-y-1 ml-4 text-muted-foreground">
                <li>Генерация комплекта карточек (6 шт.): 6 токенов</li>
                <li>SEO-описание: 1 токен</li>
                <li>Генерация штрихкода: 1 токен</li>
                <li>Генерация видео: согласно тарифу</li>
              </ul>
              <p className="mt-3 text-muted-foreground">
                4.2. При регистрации Заказчику начисляется 10 бесплатных токенов.
              </p>
              <p className="mt-3 text-muted-foreground">
                4.3. Пополнение баланса токенов осуществляется путём оплаты одного из тарифных планов, представленных на сайте.
              </p>
              <p className="mt-3 text-muted-foreground">
                4.4. Оплата принимается через платёжную систему ЮKassa. Приём платежей осуществляет ИП Кот А.С. (ИНН 502007134804) в качестве платёжного агента.
              </p>
            </div>
            ...
            <div className="p-4 rounded-xl bg-secondary/50">
              ...
              <ul className="list-none space-y-1 text-xs text-muted-foreground">
                <li><strong>Наименование:</strong> ИП Кот Александр Сергеевич</li>
                <li><strong>ИНН:</strong> 502007134804</li>
                <li><strong>ОГРН:</strong> 319500700012749</li>
              </ul>
            </div>
          </CardContent>
        </Card>
