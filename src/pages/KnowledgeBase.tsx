...
const faqItems = [
  { 
    ...
    answer: "Зарегистрируйтесь на сайте, используя email или Google-аккаунт. После регистрации вы получите бесплатные токены для тестирования сервиса. Перейдите в раздел «Генерация» и загрузите первое фото товара. Выберите стиль, добавьте описание товара и нажмите «Сгенерировать». Через 2-3 минуты набор карточек готов к скачиванию." 
  },
  { 
    question: "Сколько токенов даётся при регистрации?", 
    answer: "При регистрации вы получаете бесплатные токены для тестирования сервиса. Их достаточно для генерации нескольких карточек и SEO-описаний, чтобы вы могли оценить качество работы ИИ перед покупкой токенов." 
  },
  { 
...
После успешной регистрации на ваш баланс автоматически зачисляются бесплатные токены. Их достаточно для тестирования основных функций сервиса.
