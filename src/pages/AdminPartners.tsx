...
import { LogOut, Users, TrendingUp, CreditCard, DollarSign, AlertCircle, Check, ArrowLeft, Handshake, BarChart3, FileText, Gift, Megaphone } from "lucide-react";
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Управление партнерской программой</p>
              </div>
            </div>
      ...
      <div className="flex flex-1">
        {/* Sidebar for desktop */}
        <div className="hidden md:block w-64 shrink-0 bg-card border-r border-border">
          <nav className="p-4 space-y-2">
            ...
            <Button
              variant="secondary"
              className="w-full justify-start bg-wb-purple/10 text-wb-purple"
            >
