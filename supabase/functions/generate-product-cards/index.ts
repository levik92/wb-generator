...
Композиция:
• Вертикальный кадр (3:4, целевой размер 1024×1792).  
...
• Формат: вертикаль 1024×1792 (последующая обрезка до 960×1280).
...
• Photorealistic, commercial e-commerce style, 1024×1792.`,
...
Композиция:
• Вертикаль 3:4 (целевой рендер 1024×1792).
...
Композиция:
• Вертикаль 3:4 (целевой 1024×1792).
