-- Fix notification type from 'success' to 'payment_confirmed' in both overloads

-- 1-param version (YooKassa)
...
-- 2-param version (CloudPayments)
CREATE OR REPLACE FUNCTION public.process_payment_success(payment_id_param text, external_id_param text DEFAULT NULL::text)
 RETURNS boolean
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
